...
const en = {
  ...
  raindropImportFailed: 'Source import failed: {reason}',
  backupAndRestore: 'Backup and restore',
  webDavUrl: 'WebDAV address',
  webDavDirectory: 'Remote directory',
  webDavUsername: 'WebDAV username',
  webDavPassword: 'WebDAV password',
  recoveryPassword: 'Recovery password',
  encryptedBackups: 'Encrypt backups by default',
  autoBackup: 'Automatic backup after changes',
  permissionDisclosure: 'OpenBookmark requests broad host access, but reads pages only when you save a page or refresh selected metadata. Backups go only to your configured WebDAV target.',
  saveSettings: 'Save settings',
  testConnection: 'Test connection',
  manualBackup: 'Back up now',
  listBackups: 'List backups',
  restorePassword: 'Restore password',
  backupSettingsSaved: 'Backup settings saved locally.',
  backupSettingsIncomplete: 'Complete WebDAV settings and recovery password before backing up.',
  webDavConnected: 'WebDAV connection works.',
  webDavAuthFailed: 'WebDAV authentication failed.',
  webDavNotWritable: 'WebDAV path is not writable.',
  webDavNetworkFailed: 'WebDAV network request failed.',
  backupVersionsLoaded: 'Loaded {count} backup version(s).',
  backupDone: 'Backup {name} uploaded ({size} bytes).',
  backupFailed: 'Backup failed: {reason}',
  confirmBackupRestore: 'Restore {name} from {exportedAt}? This replaces local data with {bookmarks} bookmark(s), {collections} collection(s), and {tombstones} Trash/deletion record(s). Changes: +{added}/-{removed} bookmarks.',
  backupRestoreDone: 'Backup restore complete: {bookmarks} bookmarks, {collections} collections.',
  backupRestoreFailed: 'Backup restore failed: {reason}',
  clearThumbnailCache: 'Clear thumbnail cache',
  regenerateThumbnailCache: 'Regenerate thumbnails',
  thumbnailCacheCleared: 'Thumbnail cache cleared.',
  thumbnailCacheProgress: 'Thumbnail cache: {done}/{total}.',
  thumbnailCacheDone: 'Thumbnail cache regenerated for {count} bookmarks.',
} as const;
...
const zh: Record<MessageKey, string> = {
  ...
  raindropImportFailed: '来源导入失败：{reason}',
  ...
  encryptedBackups: '默认加密备份',
  autoBackup: '数据变化后自动备份',
  permissionDisclosure: 'OpenBookmark 会申请广泛主机权限，但只会在你保存页面或刷新所选元数据时读取页面。备份只发送到你配置的 WebDAV 目标。',
  saveSettings: '保存设置',
  testConnection: '测试连接',
  manualBackup: '立即备份',
  listBackups: '列出备份',
  restorePassword: '恢复密码',
  backupSettingsSaved: '备份设置已保存在本地。',
  backupSettingsIncomplete: '请先填写 WebDAV 设置和恢复密码再备份。',
  webDavConnected: 'WebDAV 连接正常。',
  webDavAuthFailed: 'WebDAV 认证失败。',
  webDavNotWritable: 'WebDAV 路径不可写。',
  webDavNetworkFailed: 'WebDAV 网络请求失败。',
  backupVersionsLoaded: '已加载 {count} 个备份版本。',
  backupDone: '已上传备份 {name}（{size} 字节）。',
  backupFailed: '备份失败：{reason}',
  confirmBackupRestore: '从 {exportedAt} 的 {name} 恢复吗？这会用 {bookmarks} 个书签、{collections} 个收藏夹和 {tombstones} 个回收站/删除记录替换本地数据。变化：书签 +{added}/-{removed}。',
  backupRestoreDone: '备份恢复完成：{bookmarks} 个书签，{collections} 个收藏夹。',
  backupRestoreFailed: '备份恢复失败：{reason}',
  clearThumbnailCache: '清空缩略图缓存',
  regenerateThumbnailCache: '重新生成缩略图',
  thumbnailCacheCleared: '缩略图缓存已清空。',
  thumbnailCacheProgress: '缩略图缓存：{done}/{total}。',
  thumbnailCacheDone: '已为 {count} 个书签重新生成缩略图缓存。',
};
